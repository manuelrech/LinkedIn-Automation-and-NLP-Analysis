...
utils_common.setup_begging_datasets()
...
# utils_common.repeat_times(3, utils_api.send_invitations_note, api, 20, 60)

utils_selenium.get_new_connections(stopping_id='ian-allison-438a4aaa', api= api)

utils_common.repeat_times(3, utils_api.send_message_new_1st_connections, api, 60)

# TODO sales navigator can be opened throug this link https://www.linkedin.com/sales/lead/{PROFILE_URN},nome